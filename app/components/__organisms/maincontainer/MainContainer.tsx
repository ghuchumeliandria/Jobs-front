...
export default function MainContainer() {
    return (
        <div className='w-full'>
            <div className="w-full fixed shadow-[0_2px_10px_rgba(0,0,0,0.08)] top-0 bg-white py-5  "><Header /></div>
            <div className="w-full max-w-[1440px] pt-20 z-20 min-h-[200vh] px-[100px] mx-auto  max-[1058px]:px-[70px] max-[900px]:px-5 max-[450px]:px-3 transition-all duration-300 ">
                ...
                <div className="w-full px-16 py-9 flex flex-col gap-[82px] rounded-2xl relative mt-[100px] -z-200" style={{
                    ...
                    <div className="flex gap-4">
                        <Link href={'/sign-up'}>
                            <button className='px-6 py-3 bg-white rounded-full font-semibold '>ანგარიშის შექმნა</button>
                        </Link>
