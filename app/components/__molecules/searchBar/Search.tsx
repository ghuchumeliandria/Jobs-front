...
export default function Search() {
    ...
    return (
        <div className="w-full max-w-[1032px] mx-auto mt-[105px]  bg-transparent h-[70px] py-2  rounded-full border-[1px]  pl-8 pr-2 flex items-center border-[#a155b9] max-[700px]:m-0 max-[700px]:rounded-[0px] max-[700px]:rounded-b-[20px] max-[700px]:border-t-0  transition-all duration-300a">
